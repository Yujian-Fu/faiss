...
namespace bslib{
    struct LQ_quantizer : Base_quantizer
    {
        ...
        void search_in_group(size_t n, const float * queries, const idx_t * result_labels, const float * upper_result_dists, const size_t upper_nc_per_group, const idx_t * group_idxs, float * result_dists);
