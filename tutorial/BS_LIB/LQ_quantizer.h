...
namespace bslib{
    struct LQ_quantizer : Base_quantizer
    {
        ...
        void search_in_group(const float * query, idx_t * upper_result_labels, const float * upper_result_dists, const size_t upper_search_space, const idx_t group_id, float * result_dists, idx_t * result_labels);
