...
const uint32_t ncentroids[layers-PQ_layers] = {100, 100, 1000, 50};
...
const size_t num_train[layers] = {100000000, 100000000, 100000000, 100000000};

//For searching
const size_t keep_space[layers * num_search_paras] = {20, 20, 100, 20};